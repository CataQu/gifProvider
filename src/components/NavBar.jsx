...
const NavBar = ({mostrarRandomGif, mostrarRandomTrendingGif})=> { //Se trae el método a ejecutar en onClick
  return (
      ...
      <div className="collapse navbar-collapse" id="navbarResponsive">
        <ul className="nav ml-auto">
          <li className="nav-item">
            ...
            <button onClick={() => mostrarRandomTrendingGif()} className="btn btn-success">Cargar random trending gif</button>
